...
// address: 0x8008141C
// size: 0xC
struct FRAME_HDR *GetFr__7TextDati_addr_8008141C(struct TextDat *this, int FrNum) {
}
...
// address: 0x8009A4E0
void ___7CScreen_addr_8009A4E0(struct CScreen *this, int __in_chrg);
